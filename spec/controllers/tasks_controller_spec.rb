...
describe TasksController do
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      ...
      it "redirects to the tasks project" do
        post :create, { project_id: project.id, task: valid_attributes}, valid_session
        response.should redirect_to(project_id: project.id)
      end
    end
  ...
  describe "DELETE destroy" do
    it "destroys the requested task" do
      expect {
        delete :destroy, { project_id: project.id, id: task.to_param }, valid_session
      }.to change(Task, :count).by(-1)
    end

    it "redirects to the tasks list" do
      delete :destroy, { project_id: project.id, id: task.to_param }, valid_session
      response.should redirect_to(project_tasks_url)
    end
  end
